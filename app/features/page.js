        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {mainFeatures.map((feature, index) => (
              ...
              >
                <div className={`inline-flex items-center justify-center w-16 h-16 bg-linear-to-r ${feature.color} rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className={`absolute inset-0 bg-linear-to-r ${feature.color} rounded-2xl opacity-0 group-hover:opacity-5 transition-opacity duration-300 -z-10`}></div>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <div className="bg-linear-to-r from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-12 relative overflow-hidden">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="relative bg-linear-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 px-8 py-4 rounded-xl font-semibold text-white transition-all duration-300 shadow-2xl shadow-emerald-500/20"
            >
